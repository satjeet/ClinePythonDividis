"""
Django settings for dividis project.
"""
...
WSGI_APPLICATION = 'dividis.wsgi.application'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'dividis'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Dividis API',
    'DESCRIPTION': 'API for Dividis personal development platform',
    'VERSION': '1.0.0',
